...
class GLSLShaderProgramRetained extends ShaderProgramRetained
{
	...
	ShaderError setUniform1i(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, int value)
	{
		...
		return Pipeline.getPipeline().setGLSLUniform1i(ctx, shaderProgramId, uniformLocation, value);
	}
	...
	ShaderError setUniform1f(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, float value)
	{
		...
		return Pipeline.getPipeline().setGLSLUniform1f(ctx, shaderProgramId, uniformLocation, value);
	}
	...
	ShaderError setUniform2i(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, int[] value)
	{
		...
		return Pipeline.getPipeline().setGLSLUniform2i(ctx, shaderProgramId, uniformLocation, value);
	}
	...
	ShaderError setUniform2f(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, float[] value)
	{
		...
		return Pipeline.getPipeline().setGLSLUniform2f(ctx, shaderProgramId, uniformLocation, value);
	}
	...
	ShaderError setUniform3i(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, int[] value)
	{
		...
		return Pipeline.getPipeline().setGLSLUniform3i(ctx, shaderProgramId, uniformLocation, value);
	}
	...
	ShaderError setUniform3f(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, float[] value)
	{
		...
		return Pipeline.getPipeline().setGLSLUniform3f(ctx, shaderProgramId, uniformLocation, value);
	}
	...
	ShaderError setUniform4i(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, int[] value)
	{
		...
		return Pipeline.getPipeline().setGLSLUniform4i(ctx, shaderProgramId, uniformLocation, value);
	}
	...
	ShaderError setUniform4f(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, float[] value)
	{
		...
		return Pipeline.getPipeline().setGLSLUniform4f(ctx, shaderProgramId, uniformLocation, value);
	}
	...
	ShaderError setUniformMatrix3f(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, float[] value)
	{
		...
		return Pipeline.getPipeline().setGLSLUniformMatrix3f(ctx, shaderProgramId, uniformLocation, value);
	}
	...
	ShaderError setUniformMatrix4f(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, float[] value)
	{
		...
		return Pipeline.getPipeline().setGLSLUniformMatrix4f(ctx, shaderProgramId, uniformLocation, value);
	}
	...
	ShaderError setUniform1iArray(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, int numElements, int[] value)
	{
		...
		return Pipeline.getPipeline().setGLSLUniform1iArray(ctx, shaderProgramId, uniformLocation, numElements, value);
	}

	@Override
	ShaderError setUniform1fArray(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, int numElements,
			float[] value)
	{

		return Pipeline.getPipeline().setGLSLUniform1fArray(ctx, shaderProgramId, uniformLocation, numElements, value);
	}
	...
	ShaderError setUniform2iArray(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, int numElements, int[] value)
	{
		...
		return Pipeline.getPipeline().setGLSLUniform2iArray(ctx, shaderProgramId, uniformLocation, numElements, value);
	}

	@Override
	ShaderError setUniform2fArray(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, int numElements,
			float[] value)
	{

		return Pipeline.getPipeline().setGLSLUniform2fArray(ctx, shaderProgramId, uniformLocation, numElements, value);
	}
	...
	ShaderError setUniform3iArray(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, int numElements, int[] value)
	{
		...
		return Pipeline.getPipeline().setGLSLUniform3iArray(ctx, shaderProgramId, uniformLocation, numElements, value);
	}

	@Override
	ShaderError setUniform3fArray(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, int numElements,
			float[] value)
	{

		return Pipeline.getPipeline().setGLSLUniform3fArray(ctx, shaderProgramId, uniformLocation, numElements, value);
	}
	...
	ShaderError setUniform4iArray(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, int numElements, int[] value)
	{
		...
		return Pipeline.getPipeline().setGLSLUniform4iArray(ctx, shaderProgramId, uniformLocation, numElements, value);
	}

	@Override
	ShaderError setUniform4fArray(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, int numElements,
			float[] value)
	{

		return Pipeline.getPipeline().setGLSLUniform4fArray(ctx, shaderProgramId, uniformLocation, numElements, value);
	}

	@Override
	ShaderError setUniformMatrix3fArray(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, int numElements,
			float[] value)
	{

		return Pipeline.getPipeline().setGLSLUniformMatrix3fArray(ctx, shaderProgramId, uniformLocation, numElements, value);
	}

	@Override
	ShaderError setUniformMatrix4fArray(Context ctx, ShaderProgramId shaderProgramId, ShaderAttrLoc uniformLocation, int numElements,
			float[] value)
	{

		return Pipeline.getPipeline().setGLSLUniformMatrix4fArray(ctx, shaderProgramId, uniformLocation, numElements, value);
	}
	...
	@Override
	void lookupShaderAttrNames(Context ctx, ShaderProgramId shaderProgramId, String[] attrNames, AttrNameInfo[] attrNameInfoArr)
	{
		...
		Pipeline.getPipeline().lookupGLSLShaderAttrNames(ctx, shaderProgramId, numAttrNames, attrNames, locArr, typeArr, sizeArr,
				isArrayArr);
