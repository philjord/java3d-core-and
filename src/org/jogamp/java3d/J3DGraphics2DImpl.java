...
final class J3DGraphics2DImpl extends J3DGraphics2D {
	...
	{
		// I think the offscreen guy is the delegate
	...
	// the init call to reset these possibly?
/*	xmax = 0;
	ymax = 0;
	xmin = width;
	ymin = height;*/
	...
	//TODO: PJ fill these in when available
...
/* PJ	@Override
    ...
    public final void drawString(String s, float x, float y) {
     /*PJ  TextLayout layout = new TextLayout(s, getFont(),
...
/*PJ    @Override
	...
	px = (int) ptDst1.x;
	py = (int) ptDst1.y;
	px=x;py=y; //TODO: what the hell is this here for?? PJ
    ...
    void clearOffScreen() {
//PJ	Composite comp = offScreenGraphics2D.getComposite();
